...
func wireApp(confServer *conf.Server, confData *conf.Data, logger *slog.Logger) (*kratos.App, func(), error) {
	...
	grpcServer := server.NewGRPCServer(confServer, logger, healthService, expertService)
	httpServer := server.NewHTTPServer(confServer, logger, healthService, expertService)
