...
type Data struct {
	...
	Inference     *Data_Inference        `protobuf:"bytes,3,opt,name=inference,proto3" json:"inference,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data) GetInference() *Data_Inference {
	if x != nil {
		return x.Inference
	}
	return nil
...
type Data_Inference struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Addr            string                 `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`
	Timeout         *durationpb.Duration   `protobuf:"bytes,2,opt,name=timeout,proto3" json:"timeout,omitempty"`
	MaxMessageBytes int32                  `protobuf:"varint,3,opt,name=max_message_bytes,json=maxMessageBytes,proto3" json:"max_message_bytes,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *Data_Inference) Reset() {
	*x = Data_Inference{}
...
func (x *Data_Inference) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Inference) ProtoMessage() {}

func (x *Data_Inference) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Inference.ProtoReflect.Descriptor instead.
func (*Data_Inference) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_Inference) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Data_Inference) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *Data_Inference) GetMaxMessageBytes() int32 {
	if x != nil {
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\tinference\x18\x03 \x01(\v2\x1a.kratos.api.Data.InferenceR\tinference\x1a:\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1a\x80\x01\n" +
	"\tInference\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12*\n" +
	"\x11max_message_bytes\x18\x03 \x01(\x05R\x0fmaxMessageBytesB\"Z astraflow-api/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Data_Inference)(nil),      // 7: kratos.api.Data.Inference
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.inference:type_name -> kratos.api.Data.Inference
	...
	8,  // 11: kratos.api.Data.Inference.timeout:type_name -> google.protobuf.Duration
