...
const shellQuote = require("next/dist/compiled/shell-quote") as ShellQuoteModule
const shellQuoteParse = shellQuote.parse
const shellQuoteQuote = shellQuote.quote
