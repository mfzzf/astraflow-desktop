...
const en = {
  ...
  appUpdateDownloadedWaiting:
    "Downloaded. Restart AstraFlow when you are ready to install.",
  ...
  loginPrivacyAgreementLink: "Privacy Protocol",
  loginPrivacyAgreementSuffix: ". Content is AI-generated and for reference only.",
...
const zh: Dictionary = {
  ...
  loginPrivacyAgreementSuffix: "。内容由 AI 生成，仅供参考。",
