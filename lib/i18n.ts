...
const en = {
  ...
  loginCompShareChecking: "Checking credential status...",
...
const zh: Dictionary = {
  ...
  loginCompShareChecking: "正在检查凭证状态...",
  loginCompShareValidating: "正在校验凭证...",
  loginCompShareSubmit: "连接 CompShare",
  loginCompShareErrorTitle: "无法连接 CompShare",
  loginCompShareStatusLoadFailed: "无法检查 CompShare 凭证状态。",
  loginCompShareFailed: "无法校验这些 CompShare 凭证。",
