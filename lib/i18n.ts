...
const en = {
  ...
  settingsEnvironmentDescription:
    "Manage the shared Python, Node.js/npm, and package environments used by CompShare and local sandboxes.",
  ...
  appUpdateCurrent: "CompShare is up to date.",
  ...
  appUpdateDownloadedWaiting:
    "Downloaded. Restart CompShare when you are ready to install.",
  ...
  appUpdateInstallNow: "Restart and install",
  appUpdateInstalling: "Preparing update installation...",
  appUpdateInstallRestarting: "Restarting to install the downloaded update...",
  appUpdateInstallFailed: "Unable to install update.",
  appUpdateInstallUnavailable:
    "Update installation is only available in the desktop app.",
  project: "Project",
  ...
  loginSyncingModelverse: "Synchronizing CompShare access...",
  loginComplete: "Login complete. Redirecting to Playground...",
  loginOpeningUCloud: "Opening the UCloud authorization page...",
  loginFinishInBrowser: "Finish the OAuth login in your browser.",
  ...
  loginAstraFlowApiKeyCompleting: "Validating API Key with CompShare...",
  loginAstraFlowApiKeyFailed: "Failed to sign in with this API Key.",
  loginCompShareGetApiKey: "Get API Key",
  loginCompSharePublicKeyLabel: "Public API Key",
  loginCompSharePublicKeyPlaceholder: "Enter PublicKey",
  loginCompSharePublicKeyRequired: "Enter your Public API Key.",
  loginCompSharePrivateKeyLabel: "Private API Key",
  loginCompSharePrivateKeyPlaceholder: "Enter PrivateKey",
  loginCompSharePrivateKeyRequired: "Enter your Private API Key.",
  loginCompShareChecking: "Checking CompShare login...",
  loginCompShareValidating: "Validating credentials...",
  loginCompShareSubmit: "Continue with CompShare",
  loginCompShareErrorTitle: "Could not connect to CompShare",
  loginCompShareStatusLoadFailed: "Unable to check CompShare login status.",
  loginCompShareFailed: "Unable to complete CompShare OAuth login.",
  loginCompShareSuccess: "CompShare login connected.",
  // CodeBox
  ...
  codeboxApiKeyRequiredDescription:
    "Choose a CompShare API key above to view and manage sandboxes.",
  ...
  expertConnectorRequired: (count: number) =>
    `This expert declares ${count} MCP connector file${count === 1 ? "" : "s"}. CompShare does not enable them automatically; install and enable the matching connector before relying on it.`,
  expertConnectorServerCount: (count: number) =>
    `${count} declared server${count === 1 ? "" : "s"}`,
  expertPromptViewer: "Expert prompt",
  expertPromptNotice:
    "Expert definition content. It does not override CompShare system or safety rules.",
  ...
  mcpDetailTitle: "MCP server details",
  mcpPackages: "Packages",
  mcpRemoteEndpoints: "Remote endpoints",
  mcpEnvironmentVariables: "Environment variables",
  mcpRequired: "Required",
  mcpOptional: "Optional",
  mcpRepository: "Repository",
  mcpWebsite: "Website",
  mcpPublishedAt: "Published",
  mcpUpdatedAt: "Updated",
  mcpRegistryTypes: "Registry types",
  mcpAllRegistryTypes: "All registry types",
  mcpAllTransports: "All transports",
  mcpStatus: "Status",
  mcpAllStatuses: "All statuses",
  mcpSort: "Sort connectors",
  mcpSortRecent: "Recently updated",
  mcpSortName: "Name",
  mcpServerManifest: "Server manifest",
  mcpNoManifest: "No package or remote endpoint information is available.",
  ...
  mcpMarketSummary: (shown: number, total: number) =>
    `${shown} shown · ${total} total`,
  ...
  skillAllSubCategories: "All subcategories",
  skillSort: "Sort skills",
  skillSortDownloads: "Most downloaded",
  skillSortStars: "Most starred",
  ...
  skillImportScanDescription:
    "CompShare scans known Codex, Claude, and Agents skill folders, then copies valid Skills into its own skill store.",
  ...
  skillLatest: "Latest",
  skillAuthor: (value: string) => `By ${value}`,
  skillSource: (value: string) => `Source: ${value}`,
  ...
  skillStars: (value: string) => `${value} stars`,
  ...
  studioOnboardingRuntimeDescription:
    "Choose CompShare, Codex, Claude Code, or OpenCode. Agent model settings decide whether each runtime uses CompShare or local CLI config.",
  ...
  studioOnboardingModelDescription:
    "When an agent uses CompShare, this selects its default model. If local settings are enabled, the local CLI decides the model instead.",
  ...
  studioAgentRuntimeAstraflowDescription:
    "Built-in CompShare agent with package models, skills, MCP tools, and local or remote sandbox execution.",
  ...
  studioWorkspaceRemoveLocalConfirm:
    "This only removes the workspace from CompShare. Files on disk are not changed.",
  ...
  studioLocalProjectRemoveConfirm:
    "This only removes the project from CompShare. Files on disk are not changed.",
  ...
  studioLocalProjectLocalDescription:
    "Run on this machine. CompShare Agent uses the selected project or default local workspace; external agents use their own CLI config.",
  studioLocalProjectRemote: "Remote",
  studioLocalProjectRemoteDescription:
    "Run CompShare Agent in the remote sandbox. Selecting this switches to CompShare Agent when needed.",
  ...
  studioSlashMenuBuiltIn: "Built-in",
  ...
  studioCommandToolsDescription: "Show the Pi tools enabled by CompShare.",
  ...
  studioCommandExportDescription: "Download this conversation as Markdown.",
  studioCommandExportRequiresSession:
    "Start the conversation before exporting it.",
  studioCommandExportStarted: "Markdown export started.",
  studioCommandUndoDescription:
    "Undo the latest CompShare turn and restore its files.",
  studioCommandRedoDescription: "Redo the latest undone CompShare turn.",
  ...
  studioAstraFlowPlanUnavailable:
    "This CompShare Agent session does not provide Plan mode.",
  studioAstraFlowControlFailed: "CompShare Agent control failed",
  studioAstraFlowStartChatFirst:
    "Start a session before changing CompShare Agent mode.",
  ...
  studioCodexControlFailed: "Codex control failed",
  studioCodexStartChatFirst: "Start a chat before changing Codex mode.",
  studioCodexGoalActive: "Active",
  studioCodexGoalPaused: "Paused",
  studioCodexGoalPause: "Pause goal",
  studioCodexGoalResume: "Resume goal",
  studioCodexGoalEdit: "Edit goal",
  studioCodexGoalClear: "Clear goal",
  studioCodexGoalTokenBudget: (count: number) =>
    `${count.toLocaleString("en-US")} token budget`,
  studioCodexGoalElapsed: (seconds: number) =>
    `${Math.max(0, Math.round(seconds)).toLocaleString("en-US")}s elapsed`,
  studioClaudeOptions: "Claude Code options",
  ...
  studioClaudePlanApproveEdits: "Yes, auto-accept edits",
  studioClaudePlanApproveManual: "Yes, manually approve edits",
  studioClaudePlanApproveBypass: "Yes, bypass permissions",
  studioClaudePlanKeepPlanning: "No, keep planning",
  studioClaudeFastMode: "Fast mode",
  studioClaudeUsageLimit: "Claude usage limit",
  studioClaudeUsageAvailable: "Available",
  studioClaudeUsagePercent: (percent: number) => `${percent}% used`,
  studioClaudeUsageResets: "Resets",
  studioClaudeActiveGoal: "Active goal",
  studioClaudeBackgroundTask: "Background task",
  studioClaudeBackgroundTasks: (count: number) =>
    `${count} background ${count === 1 ? "task" : "tasks"}`,
  studioClaudeGoalIterations: (count: number) =>
    `${count.toLocaleString("en-US")} iterations`,
  studioClaudeSuggestedPrompt: "Suggested next prompt",
  studioClaudeUseSuggestion: "Use this suggestion",
  studioClaudeAuthenticating: "Claude Code is authenticating…",
  studioClaudeControlFailed: "Claude Code control failed",
  studioClaudeStartChatFirst:
    "Start a chat before changing Claude Code session options.",
  studioClaudeForkSession: "Fork conversation",
  studioOpenCodeOptions: "OpenCode options",
  studioOpenCodeOptionsUnavailable:
    "OpenCode will publish its live model, effort, and agent mode options after the session starts.",
  studioOpenCodePlanMode: "Plan",
  studioOpenCodePlanUnavailable:
    "This OpenCode session does not provide Plan mode.",
  studioOpenCodeControlFailed: "OpenCode control failed",
  studioOpenCodeStartChatFirst:
    "Start a chat before changing OpenCode session options.",
  studioOpenCodeForkSession: "Fork conversation",
  studioDisclaimer: "CompShare can make mistakes. Check important details.",
  ...
  studioTerminalDesktopUnavailable:
    "Terminal is available in the CompShare desktop app.",
  ...
  studioToolCompactingContext: "Compacting context",
  studioToolCompactedContext: "Context compacted",
  studioToolContextCompactionFailed: "Context compaction failed",
  ...
  studioToolJsonItems: (count: number) =>
    `${count} ${count === 1 ? "item" : "items"}`,
  studioToolJsonFields: (count: number) =>
  ...
  studioPermissionFeedbackPlaceholder: "No, tell CompShare how to adjust",
  ...
  studioApiSettingsDescription:
    "Manage CompShare API keys and the key selected for this app.",
  ...
  studioApiKeyStatusModelverseDisabled: "Model service disabled",
  ...
  studioApiKeyModelverseEnabled: "Enable model service",
  ...
  studioApiKeyDisabledCannotUse:
    "Enable the model service before using this key in the app.",
  ...
  studioAstraFlowApiKeyTitle: "CompShare API Key",
  studioAstraFlowApiKeyDescription: "Custom API Key",
  studioAstraFlowApiKeyAdd: "Add key",
  studioAstraFlowApiKeyChange: "Change Key",
  studioAstraFlowApiKeyChangeTitle: "Change CompShare API Key",
  studioAstraFlowApiKeyChangeDescription: "Paste API Key",
  studioAstraFlowApiKeyChanged: "CompShare API Key saved.",
  studioAstraFlowApiKeyLoadFailed: "Failed to load CompShare API Key.",
  studioAstraFlowApiKeyChangeFailed: "Failed to validate CompShare API Key.",
  studioAstraFlowApiKeyShow: "Show CompShare API Key",
  studioAstraFlowApiKeyHide: "Hide CompShare API Key",
  studioAstraFlowApiKeySave: "Save Key",
  studioAstraFlowApiKeyCopyUnavailable:
    "No CompShare API Key is available to copy.",
  ...
  studioModelverseApiKeyLabel: "CompShare API key",
  studioModelverseApiKeyPlaceholder: "Select a CompShare API key",
  studioModelverseApiKeyLoading: "Loading CompShare API keys...",
  studioModelverseApiKeyEmpty:
    "No active CompShare API key is available in this project.",
  studioModelverseApiKeyRequired: "Select a CompShare API key.",
  studioModelverseApiKeySave: "Use this key",
  studioModelverseApiKeySaving: "Saving key...",
  studioModelverseApiKeySaved: "CompShare API key is ready.",
  ...
  copyModelIdFailed: "Unable to copy model ID.",
  copied: "Copied",
  showMore: "Show More",
  showLess: "Show Less",
  none: "None",
...
const zh: Dictionary = {
  ...
  settingsEnvironmentDescription:
    "管理 CompShare 与本地沙箱统一使用的 Python、Node.js/npm 和依赖包环境。",
  ...
  appUpdateCheck: "检查更新",
  appUpdateCurrent: "CompShare 已是最新版本。",
  appUpdateAvailable: (version: string) => `发现新版本：v${version}`,
  appUpdateLatest: (version: string) => `最新版本：v${version}`,
  appUpdateDownloading: (version: string, percent: number) =>
    `正在下载 v${version}：${percent}%`,
  appUpdateDownloadedWaiting: "更新已下载，可在方便时手动重启安装。",
  appUpdateRestarting: "正在重启并安装更新...",
  appUpdateCheckFailed: "检查更新失败。",
  appUpdateBadge: "更新",
  appUpdateInstallNow: "重启并安装",
  appUpdateInstalling: "正在准备安装更新...",
  appUpdateInstallRestarting: "正在重启并安装已下载的更新。",
  appUpdateInstallFailed: "无法安装更新。",
  appUpdateInstallUnavailable: "更新安装只在桌面应用中可用。",
  project: "项目",
  ...
  loginSyncingModelverse: "正在同步 CompShare 访问权限……",
  loginComplete: "登录完成，正在跳转到体验页……",
  loginOpeningUCloud: "正在打开 UCloud 授权页面……",
  loginFinishInBrowser: "请在浏览器中完成 OAuth 登录。",
  ...
  loginAstraFlowApiKeyCompleting: "正在通过 CompShare 校验 API Key...",
  loginAstraFlowApiKeyFailed: "使用这个 API Key 登录失败。",
  loginCompShareGetApiKey: "获取 API Key",
  loginCompSharePublicKeyLabel: "Public API Key",
  loginCompSharePublicKeyPlaceholder: "输入 PublicKey",
  loginCompSharePublicKeyRequired: "请输入 Public API Key。",
  loginCompSharePrivateKeyLabel: "Private API Key",
  loginCompSharePrivateKeyPlaceholder: "输入 PrivateKey",
  loginCompSharePrivateKeyRequired: "请输入 Private API Key。",
  loginCompShareChecking: "正在检查 CompShare 登录状态...",
  loginCompShareValidating: "正在校验凭证...",
  loginCompShareSubmit: "使用 CompShare 登录",
  loginCompShareErrorTitle: "无法连接 CompShare",
  loginCompShareStatusLoadFailed: "无法检查 CompShare 登录状态。",
  loginCompShareFailed: "无法完成 CompShare OAuth 登录。",
  loginCompShareSuccess: "CompShare 登录成功。",
  // CodeBox
  ...
  codeboxApiKeyRequiredDescription:
    "在上方选择一个 CompShare API Key，即可查看和管理沙箱。",
  ...
  expertSkills: "技能",
  expertConnectorRequired: (count: number) =>
    `该专家声明了 ${count} 个 MCP 连接器文件。CompShare 不会自动启用，请先安装并启用匹配的连接器后再依赖相关能力。`,
  expertConnectorServerCount: (count: number) => `${count} 个声明的服务`,
  expertPromptViewer: "专家 prompt",
  expertPromptNotice: "专家定义内容，不覆盖 CompShare 系统规则和安全规则。",
  ...
  mcpInstall: "安装",
  mcpInstalled: "已安装",
  mcpDetailTitle: "MCP 服务详情",
  mcpPackages: "安装包",
  mcpRemoteEndpoints: "远程端点",
  mcpEnvironmentVariables: "环境变量",
  mcpRequired: "必填",
  mcpOptional: "可选",
  mcpRepository: "代码仓库",
  mcpWebsite: "网站",
  mcpPublishedAt: "发布于",
  mcpUpdatedAt: "更新于",
  mcpRegistryTypes: "包类型",
  mcpAllRegistryTypes: "全部包类型",
  mcpAllTransports: "全部传输方式",
  mcpStatus: "状态",
  mcpAllStatuses: "全部状态",
  mcpSort: "MCP 排序",
  mcpSortRecent: "最近更新",
  mcpSortName: "名称",
  mcpServerManifest: "服务清单",
  mcpNoManifest: "暂无安装包或远程端点信息。",
  mcpUpdated: "MCP 已更新。",
  mcpTest: "测试",
  mcpTesting: "测试中...",
  ...
  skillSubCategory: "子分类",
  skillAllSubCategories: "全部子分类",
  skillSort: "技能排序",
  ...
  skillImportScanDescription:
    "CompShare 会扫描常见 Codex、Claude 和 Agents 技能目录，并把合法 Skills 复制到自己的技能存储。",
  ...
  skillLatest: "最新",
  skillAuthor: (value: string) => `作者：${value}`,
  skillSource: (value: string) => `来源：${value}`,
  skillNoDescription: "暂无技能描述。",
  skillNoReadme: "暂无 SKILL.md 内容。",
  skillDownloads: (value: string) => `${value} 次下载`,
  skillStars: (value: string) => `${value} 收藏`,
  ...
  studioOnboardingRuntimeDescription:
    "选择 CompShare、Codex、Claude Code 或 OpenCode；Agent 模型设置会决定每个运行时使用 CompShare 还是本机 CLI 配置。",
  ...
  studioOnboardingModelDescription:
    "当 Agent 使用 CompShare 时，这里选择默认模型；如果已开启本机配置，模型会由本机 CLI 自己决定。",
  ...
  studioAgentRuntimeAstraflowDescription:
    "CompShare 内置智能体使用套餐模型，支持技能、MCP 工具，以及本地或远程沙箱执行。",
  studioAgentRuntimeCodexDescription:
  ...
  studioWorkspaceRemoveLocalConfirm:
    "这里只会从 CompShare 移除工作区，不会改动磁盘上的文件。",
  studioWorkspaceRemoveSandboxConfirm:
  ...
  studioLocalProjectRemoveConfirm:
    "这里只会从 CompShare 移除项目记录，不会改动磁盘上的文件。",
  ...
  studioLocalProjectLocalDescription:
    "在这台机器上运行。CompShare Agent 使用所选项目或默认本地工作区；外部智能体使用自己的 CLI 配置。",
  studioLocalProjectRemote: "远程沙箱",
  studioLocalProjectRemoteDescription:
    "在远程沙箱中运行 CompShare Agent。需要时会自动切换到 CompShare Agent。",
  ...
  studioCommandToolsDescription: "查看 CompShare 已启用的 Pi 工具。",
  ...
  studioCommandExportDescription: "将当前会话下载为 Markdown。",
  studioCommandExportRequiresSession: "开始会话后才能导出。",
  studioCommandExportStarted: "正在导出 Markdown。",
  studioCommandUndoDescription: "撤销最近一轮 CompShare 对话并恢复文件。",
  ...
  studioPlanStep: (current: number, total: number) =>
    `第 ${current} / ${total} 步`,
  studioAstraFlowPlanUnavailable: "当前 CompShare Agent 会话未提供计划模式。",
  studioAstraFlowControlFailed: "CompShare Agent 控制失败",
  studioAstraFlowStartChatFirst: "请先开始会话，再调整 CompShare Agent 模式。",
  studioCodexPlanMode: "计划",
  studioCodexPlanShortcut: "切换计划模式（Shift+Tab）",
  studioCodexPlanUnavailable: "当前 Codex 会话未提供计划模式。",
  studioCodexFastMode: "快速模式",
  studioCodexFastUnavailable: "当前模型不支持快速模式。",
  studioCodexControlFailed: "Codex 控制失败",
  studioCodexStartChatFirst: "请先开始会话，再切换 Codex 模式。",
  studioCodexGoalActive: "进行中",
  studioCodexGoalPaused: "已暂停",
  studioCodexGoalPause: "暂停目标",
  studioCodexGoalResume: "继续目标",
  studioCodexGoalEdit: "编辑目标",
  studioCodexGoalClear: "清除目标",
  studioCodexGoalTokenBudget: (count: number) =>
    `${count.toLocaleString("zh-CN")} Token 预算`,
  studioCodexGoalElapsed: (seconds: number) =>
    `已用 ${Math.max(0, Math.round(seconds)).toLocaleString("zh-CN")} 秒`,
  studioClaudeOptions: "Claude Code 选项",
  studioClaudeOptionsUnavailable:
  ...
  studioClaudePlanApproveManual: "同意，手动批准编辑",
  studioClaudePlanApproveBypass: "同意，绕过权限",
  studioClaudePlanKeepPlanning: "不同意，继续规划",
  studioClaudeFastMode: "快速模式",
  studioClaudeUsageLimit: "Claude 使用限额",
  studioClaudeUsageAvailable: "可用",
  studioClaudeUsagePercent: (percent: number) => `已使用 ${percent}%`,
  studioClaudeUsageResets: "重置时间",
  studioClaudeActiveGoal: "当前目标",
  studioClaudeBackgroundTask: "后台任务",
  studioClaudeBackgroundTasks: (count: number) => `${count} 个后台任务`,
  studioClaudeGoalIterations: (count: number) =>
    `已迭代 ${count.toLocaleString("zh-CN")} 次`,
  studioClaudeSuggestedPrompt: "建议的下一条提示词",
  studioClaudeUseSuggestion: "使用这条建议",
  studioClaudeAuthenticating: "Claude Code 正在认证…",
  studioClaudeControlFailed: "Claude Code 控制失败",
  studioClaudeStartChatFirst: "请先开始会话，再调整 Claude Code 会话选项。",
  studioClaudeForkSession: "分叉会话",
  studioOpenCodeOptions: "OpenCode 选项",
  studioOpenCodeOptionsUnavailable:
    "会话启动后，OpenCode 会提供实时的模型、思考强度与 Agent 模式选项。",
  studioOpenCodePlanMode: "计划",
  studioOpenCodePlanUnavailable: "当前 OpenCode 会话未提供计划模式。",
  studioOpenCodeControlFailed: "OpenCode 控制失败",
  studioOpenCodeStartChatFirst: "请先开始会话，再调整 OpenCode 会话选项。",
  studioOpenCodeForkSession: "分叉会话",
  studioDisclaimer: "CompShare 也可能会犯错。请核查重要信息。",
  ...
  studioTerminalDesktopUnavailable: "终端只在 CompShare 桌面应用中可用。",
  ...
  studioToolCompactingContext: "正在压缩上下文",
  studioToolCompactedContext: "上下文已压缩",
  studioToolContextCompactionFailed: "上下文压缩失败",
  ...
  studioPermissionFeedbackPlaceholder: "否，请告诉 CompShare 如何调整",
  ...
  studioApiSettingsBack: "Studio",
  studioApiSettingsDescription:
    "管理 CompShare API Key，并选择当前应用实际使用的 Key。",
  studioApiSettingsSummary: (visibleCount: number, totalCount: number) =>
  ...
  studioApiKeyStatusModelverseDisabled: "模型服务关闭",
  studioApiKeyKeyId: "Key ID",
  studioApiKeyPreview: "API Key",
  studioApiKeyLoading: "正在加载 API Key...",
  studioApiKeyNoKeys: "暂无 API Key。",
  studioApiKeyEmptyHint: "创建 API Key 后即可在应用里使用 CompShare 模型。",
  studioApiKeySecretHidden: "完整密钥仅由 UCloud 展示。",
  studioApiKeyModelverseOn: "模型服务",
  studioApiKeyModelverseOff: "模型服务关闭",
  ...
  studioApiKeyModelverseEnabled: "启用模型服务",
  ...
  studioAstraFlowApiKeyChangeTitle: "更换 CompShare API Key",
  studioAstraFlowApiKeyChangeDescription: "粘贴 API Key",
  studioAstraFlowApiKeyChanged: "CompShare API Key 已保存。",
  studioAstraFlowApiKeyLoadFailed: "加载 CompShare API Key 失败。",
  studioAstraFlowApiKeyChangeFailed: "校验 CompShare API Key 失败。",
  studioAstraFlowApiKeyShow: "显示 CompShare API Key",
  studioAstraFlowApiKeyHide: "隐藏 CompShare API Key",
  studioAstraFlowApiKeySave: "保存 Key",
  studioAstraFlowApiKeyCopyUnavailable: "没有可复制的 CompShare API Key。",
  ...
  studioModelverseApiKeyLabel: "CompShare API Key",
  studioModelverseApiKeyPlaceholder: "选择一个 CompShare API Key",
  studioModelverseApiKeyLoading: "正在加载 CompShare API Key...",
  studioModelverseApiKeyEmpty: "当前项目下没有可用的 CompShare API Key。",
  studioModelverseApiKeyRequired: "请选择一个 CompShare API Key。",
  studioModelverseApiKeySave: "使用这个 Key",
  studioModelverseApiKeySaving: "正在保存 Key...",
  studioModelverseApiKeySaved: "CompShare API Key 已就绪。",
  studioExaApiKeyLabel: "Exa API Key",
  ...
  copyModelId: "复制模型 ID",
  copyModelIdFailed: "无法复制模型 ID，请手动复制。",
  copied: "已复制",
  showMore: "展开更多",
  showLess: "收起",
  none: "无",
