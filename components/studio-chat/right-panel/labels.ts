export function getStudioRightPanelLabels(locale: string) {
  if (locale === "zh") {
    return {
      ...
      reviewDiffLoading: "正在加载完整差异…",
      reviewDiffUnavailable: "完整差异已过期或不可用。",
  ...
  return {
    ...
    reviewDiffLoading: "Loading the full diff…",
    reviewDiffUnavailable: "The full diff expired or is unavailable.",
