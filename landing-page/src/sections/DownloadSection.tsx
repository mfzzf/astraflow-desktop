...
export default function DownloadSection() {
  ...
  return (
    <section
      id="download"
      className="relative isolate mx-auto max-w-4xl scroll-mt-24 px-6 pb-28"
    >
      {/* 环境光：给上层半透明材质提供可被模糊的色彩背景 */}
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 -z-10 overflow-hidden"
      >
        <div className="absolute left-1/2 top-[38%] h-72 w-[34rem] -translate-x-[72%] rounded-full bg-[#8a96ff]/25 blur-3xl" />
        <div className="absolute left-1/2 top-[52%] h-64 w-[30rem] -translate-x-[18%] rounded-full bg-[#f7cf9b]/40 blur-3xl" />
      </div>
      ...
      <div
        ...
        className="relative mx-auto mt-10 grid w-full max-w-sm grid-cols-3 rounded-full bg-neutral-900/[0.06] p-1"
      >
        <span
          aria-hidden
        ...
        <div className="flex flex-col items-center gap-8 p-8 text-center md:flex-row md:justify-between md:p-10 md:text-left">
          <div className="flex flex-col items-center gap-5 md:flex-row md:gap-6">
            ...
            <div>
              ...
              <p className="mt-1.5 min-h-5 text-sm text-neutral-400">{meta}</p>
            </div>
          </div>
