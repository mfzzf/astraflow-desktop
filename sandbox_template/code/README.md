...
The template installs and uses Node.js 26 with npm 11.13.0 for dependency
installation and the published runtime. Both archives are checksum-verified;
pinning npm separately avoids inheriting npm CLI regressions from a Node.js
distribution update. The final build layer verifies Node.js 26 plus every
pinned Agent CLI version.
